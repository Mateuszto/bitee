...
export class Hero implements AfterViewInit {
   private readonly tuiBreakpointService: TuiBreakpointService = inject(TuiBreakpointService);
   ...
   protected tuiHeader: Signal<TuiHeader['size']> = computed((): TuiHeader['size'] => {
